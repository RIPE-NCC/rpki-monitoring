...
public class RepoUpdateAbortedException extends Exception{
    ...
    public RepoUpdateAbortedException(@Nullable String url, RrdpHttpStrategy http, String message) {
        super(MESSAGE_TEMPLATE.formatted(url, http.describe(), message));
    }

    public RepoUpdateAbortedException(@Nullable String url, RrdpHttpStrategy http, String message, Throwable cause) {
        super(MESSAGE_TEMPLATE.formatted(url, http.describe(), message), cause);
    }

    public RepoUpdateAbortedException(@Nullable String url, RrdpHttpStrategy http, Throwable cause) {
        super(MESSAGE_TEMPLATE.formatted(url, http.describe(), cause.getMessage()), cause);
    }

    public RepoUpdateAbortedException(@Nullable URI uri, RrdpHttpStrategy http, Throwable cause) {
