...
class AbstractObjectsAboutToExpireCollectorTest {
    ...
    public void itShouldGetCerNotAfterDate() throws ParseException {
        ...
        final Optional<Date> date = collector.getDateFor("A.cer", Base64.getDecoder().decode(cer));
        assertEquals(DATE_FORMAT.parse("Thu Jul 01 02:00:00 CEST 2021"), date.get());
    }
    ...
    public void itShouldGetRoaNotValidAfterDate() throws ParseException {
        ...
        final Optional<Date> date = collector.getDateFor("A.roa", Base64.getDecoder().decode(roa));
        assertEquals(DATE_FORMAT.parse("Thu Jul 01 02:00:00 CEST 2021"), date.get());
    }
    ...
    public void itShouldGetCrlNextUpdateDate() throws ParseException {
        ...
        final Optional<Date> date = collector.getDateFor("A.crl", Base64.getDecoder().decode(crl));
        assertEquals(DATE_FORMAT.parse("Wed Oct 30 09:40:17 CET 2019"), date.get());
    }
    ...
    public void itShouldGetMftNextUpdateTimeDate() throws ParseException {
        ...
        final Optional<Date> date = collector.getDateFor("A.mft", Base64.getDecoder().decode(mft));
        assertEquals(DATE_FORMAT.parse("Tue Sep 17 07:44:45 CEST 2019"), date.get());
    }

    @Test
    public void itShouldReturnEmptyForUnknownObjectType() throws ParseException {

        final Optional<Date> date = collector.getDateFor("A.bla", new byte[]{});
