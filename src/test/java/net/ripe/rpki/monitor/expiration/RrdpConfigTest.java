...
public class RrdpConfigTest {
    ...
    public void testOverrideHostname_not_set() {
        ...
        final var config = new RrdpConfig.RrdpRepositoryConfig("test-config", baseUrl + "notification.xml", null, List.of());
    ...
    public void testOverrideHostname_different_host() {
        ...
        final var config = new RrdpConfig.RrdpRepositoryConfig("test-config", baseUrl + "notification.xml", "rrdp.example.org", List.of());
    ...
    public void testOverrideHostname_broken_urls() {
        final var config = new RrdpConfig.RrdpRepositoryConfig("test-config", "https://rrdp.example.org/notification.xml", "rrdp.example.org", List.of());
